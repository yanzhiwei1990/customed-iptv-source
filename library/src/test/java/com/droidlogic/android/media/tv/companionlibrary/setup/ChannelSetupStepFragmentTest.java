 ...
 */
package com.droidlogic.android.media.tv.companionlibrary.setup;
...
import com.droidlogic.android.media.tv.companionlibrary.BuildConfig;
...
@Config(
    ...
    sdk = 23,
    manifest = "com/droidlogic/android/media/tv/companionlibrary/setup/AndroidManifest.xml"
)
public class ChannelSetupStepFragmentTest {
    ...
    public void onScanError_noChannels() {
        fragment.onScanError(EpgSyncJobService.ERROR_NO_CHANNELS);
