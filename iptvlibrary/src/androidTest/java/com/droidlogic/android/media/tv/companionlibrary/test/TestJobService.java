 ...
 */
package com.droidlogic.android.media.tv.companionlibrary.test;
...
public class TestJobService extends EpgSyncWithAdsJobService {
    ...
    public List<Channel> getChannels() {
        ...
        Uri xmlUri =
                Uri.parse("android.resource://" + mContext.getPackageName() + "/" + com.droidlogic.android.media.tv.companionlibrary.test.R.raw.xmltv)
                        .normalizeScheme();
        try {
    ...
    public List<Program> getOriginalProgramsForChannel(
        ...
        if (channel.getOriginalNetworkId() == 0) {
            ...
            testPrograms =
                ...
                == "com.droidlogic.android.sampletvinput.2-1".hashCode()) {
