...
import com.droidlogic.android.media.tv.companionlibrary.sync.SyncStatusBroadcastReceiver;

import java.util.ArrayList;
import java.util.List;

// Gradle puts all resources in the base package, so companionlibrary.R must be imported.
import com.droidlogic.android.media.tv.companionlibrary.R;
...
public abstract class ChannelSetupStepSupportFragment<J extends EpgSyncJobService>
        extends GuidedStepSupportFragment implements SyncStatusBroadcastReceiver.SyncListener {
