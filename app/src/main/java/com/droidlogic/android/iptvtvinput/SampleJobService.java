 ...
 */
package com.droidlogic.android.iptvtvinput;

import android.media.tv.TvContract;
import android.net.Uri;
import com.droidlogic.android.iptvtvinput.iptv.IptvFeedUtil;
import com.google.android.exoplayer.util.Util;
import com.droidlogic.android.media.tv.companionlibrary.ads.EpgSyncWithAdsJobService;
...
import com.droidlogic.android.media.tv.companionlibrary.xmltv.XmlTvParser;
...
public class SampleJobService extends EpgSyncWithAdsJobService {
    ...
    public List<Channel> getChannels() {
        ...
        XmlTvParser.TvListing listings = IptvFeedUtil.getRichTvListings(this);
    ...
    public List<Program> getOriginalProgramsForChannel(Uri channelUri, Channel channel,
        ...
        if (!channel.getDisplayName().equals(MPEG_DASH_CHANNEL_NAME)) {
            // Is an XMLTV Channel
            XmlTvParser.TvListing listings = IptvFeedUtil.getRichTvListings(getApplicationContext());
